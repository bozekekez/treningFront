...
const Tick = () => {
    ...
    const ai = () => { 
        ...
        if((drugo === 'x' && !peto && !prvo) || (cetvrto === 'x'&& !peto && !prvo) || (sesto === 'x' && !peto && !prvo )|| (osmo === 'x' && !peto && !prvo )){
        ...
        if(peto === 'x' && prvo !== 'o' && trece !== 'o' && sedmo !== 'o' && deveto !== 'o'){
        ...
        // if(prvo === 'x' || trece === 'x' || sedmo === 'x' || deveto === 'x' && peto !== 'x' && peto !== 'o')
        // {
        //     console.log('eo me 1')
        //     if(!peto)
        //     {
        ...
        //     }
        // }     
        if(prvo === 'x' && sedmo === 'x' && cetvrto === 'o' && peto === 'o' && sesto === 'x')
        {
            console.log('2', red)
            if(!drugo){
                return(
        ...
        if(prvo === 'x' && sedmo === 'x' && cetvrto === 'o' && peto === 'o' && sesto === 'x' && drugo === 'o' && osmo === 'x')
        {
            console.log('2', red)
            if(!deveto){
                return(
        ...
        //     }
        // }
        if(prvo === 'x' || trece === 'x' || sedmo === 'x' || deveto === 'x' && peto === 'o' && sesto === 'o' && cetvrto !== 'x' )
        {
            console.log('eo me')
            if(!cetvrto){
                return(
